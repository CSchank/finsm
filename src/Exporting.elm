            ...
            let
                ...
                loop =
                    if s0 == s1 then
                        ...
                        ""
            in
            String.concat [ "(", hashCode <| stateName s0, ") edge [", loop, position, ",in = ", String.fromInt inTheta, ", out = ", String.fromInt outTheta, "] node {$", tNameString , "$} (", hashCode <| stateName s1, ")" ]
    in
    unlines
